...
public class StudentResourceImpl extends AbstractResource implements StudentResource {
    ...
    public List<Student> getStudents(String query, Boolean active, ClassYear classYear,
        ...
        boolean isCumulativeGpaQuery = minCumGpa != null || maxCumGpa!= null;
        ...
        validate(query != null || classYear != null || expectedGraduationYearFrom != null ||
                expectedGraduationYearTo != null || isCumulativeGpaQuery || isTermGpaQuery,
        ...
        return studentDao.getStudents(
            ...
            active, expectedGraduationYearFrom, expectedGraduationYearTo, minCumGpa, 
            maxCumGpa, minTermGpa, maxTermGpa, term, year, skip, max);
    }
