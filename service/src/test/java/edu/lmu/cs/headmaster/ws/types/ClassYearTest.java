...
public class ClassYearTest {
    ...
    public void testClassYearsLate2012() {
        ...
        Assert.assertEquals(Integer.valueOf(2012), ClassYear.SENIOR.getExpectedGraduationYear(late2012));
        Assert.assertEquals(Integer.valueOf(2013), ClassYear.JUNIOR.getExpectedGraduationYear(late2012));
        Assert.assertEquals(Integer.valueOf(2014), ClassYear.SOPHOMORE.getExpectedGraduationYear(late2012));
        Assert.assertEquals(Integer.valueOf(2015), ClassYear.FRESHMAN.getExpectedGraduationYear(late2012));
    }
