...
public class StudentDaoTest extends ApplicationContextTest {
    ...
    public void testGetStudentsByLastName() {
        ...
        List<Student> students = studentDao.getStudents("cer", null, null, null, null, 0, 10);
        Assert.assertEquals(1, students.size());
        Assert.assertEquals(Long.valueOf(1000001L), students.get(0).getId());

        students = studentDao.getStudents("k", null, null, null, null, 0, 10);
    ...
    public void testGetActiveStudents() {
        List<Student> students = studentDao.getStudents(null, Boolean.TRUE, null, null, null, 0, 10);
    ...
    public void testGetInactiveStudents() {
        List<Student> students = studentDao.getStudents(null, Boolean.FALSE, null, null, null, 0, 10);
        Assert.assertEquals(2, students.size());
    ...
    public void testGetTransferStudents() {
        List<Student> students = studentDao.getStudents(null, null, null, null, Boolean.TRUE, 0, 10);
        Assert.assertEquals(3, students.size());
    ...
    public void testGetNotTransferStudents() {
        List<Student> students = studentDao.getStudents(null, null, null, null, Boolean.FALSE, 0, 10);
        Assert.assertEquals(2, students.size());
    ...
    public void testGetStudentsBySpecificExpectedGraduationYear() {
        List<Student> students = studentDao.getStudents(null, null, 2015, 2015, null, 0, 10);
        Assert.assertEquals(2, students.size());
