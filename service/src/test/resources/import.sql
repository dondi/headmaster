...
-- Test fixture grants.
insert into researchgrant(id, amount, facultymentor, title, awarded, presented) values(1000000, 10000, 'Leonard Kleinrock', 'The Worldwide Web', 'AWARDED', true);
insert into researchgrant(id, amount, facultymentor, title, awarded, presented) values(1000001, 10000, 'The Dondi', 'The New DB', 'PENDING', false);
insert into researchgrant(id, amount, facultymentor, title, awarded, presented) values(1000002, 10000, 'Alan Turing', 'Binary Good', 'DECLINED', false);
