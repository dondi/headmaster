...
-- Preloaded students.
insert into student(id, firstname, lastname) values(1000000, 'Tim', 'Berners-Lee');
insert into student(id, firstname, lastname) values(1000001, 'Vint', 'Cerf');
insert into student(id, firstname, lastname) values(1000002, 'Don', 'Knuth');
